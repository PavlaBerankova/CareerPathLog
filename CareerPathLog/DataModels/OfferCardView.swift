...
#Preview {
  ScrollView {
    VStack {
      OfferCardView(jobOffer: JobOffersEntities.mock[0], contentMenu: Text("ContentMenu"))
      OfferCardView(jobOffer: JobOffersEntities.mock[1], contentMenu: Text("ContentMenu"))
      OfferCardView(jobOffer: JobOffersEntities.mock[2], contentMenu: Text("ContentMenu"))
      OfferCardView(jobOffer: JobOffersEntities.mock[3], contentMenu: Text("ContentMenu"))
    }
    .padding(.horizontal)
  }
}
