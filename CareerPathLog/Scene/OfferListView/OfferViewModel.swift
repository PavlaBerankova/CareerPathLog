...
class OfferViewModel: ObservableObject {
    @Published var jobOffers = [
        JobOffer(
            ...
            dateOfSentCV: Calendar.current.date(from: DateComponents(year: 2023, month: 11, day: 10))!,
            dateOfReply: nil,
...
"""),
        JobOffer(
            ...
            notes: "nutnost ObjC",
            dateOfSentCV: Calendar.current.date(from: DateComponents(year: 2023, month: 11, day: 5))!,
...
"""),
        JobOffer(
            ...
            notes: nil,
            dateOfSentCV: Calendar.current.date(from: DateComponents(year: 2023, month: 10, day: 5))!,
            dateOfReply: nil,
            firstRoundOfInterview: nil,
            secondRoundOfInterview: nil,
            fullTextOffer: """
