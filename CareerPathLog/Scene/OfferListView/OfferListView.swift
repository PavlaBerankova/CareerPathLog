...
struct OfferListView: View {
    @State private var data = [
        JobOffer(
            ...
            dateOfSentCV: Calendar.current.date(from: DateComponents(year: 2023, month: 10, day: 25))!,
            dateOfReply: nil,
...
"""),
        JobOffer(
            ...
            notes: "nutnost ObjC",
            dateOfSentCV: Calendar.current.date(from: DateComponents(year: 2023, month: 11, day: 1))!,
...
"""),
        JobOffer(
            ...
            notes: nil,
            dateOfSentCV: DateComponents(year: 2023, month: 10, day: 30).date ?? Date.now,
            dateOfReply: nil,
            firstRoundOfInterview: nil,
            secondRoundOfInterview: nil,
            fullTextOffer: """
...
""")
    ...
    var body: some View {
        NavigationStack {
            List(data, id: \.id) { offer in
                OfferCardView(companyName: offer.companyName, jobTitle: offer.jobTitle, urlOffer: offer.urlOffer, dateOfSentCV: offer.dateOfSentCV, notes: offer.notes)
            }
            .listStyle(.plain)
            .toolbar {
